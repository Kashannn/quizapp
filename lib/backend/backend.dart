...
import 'schema/quick_fire_images_quiz_record.dart';
...
import 'schema/quiz_test_record.dart';
...
export 'schema/quick_fire_images_quiz_record.dart';
...
export 'schema/quiz_test_record.dart';
...
/// Functions to query QuickFireImagesQuizRecords (as a Stream and as a Future).
Future<int> queryQuickFireImagesQuizRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      QuickFireImagesQuizRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<QuickFireImagesQuizRecord>> queryQuickFireImagesQuizRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      QuickFireImagesQuizRecord.collection,
      QuickFireImagesQuizRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<QuickFireImagesQuizRecord>> queryQuickFireImagesQuizRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query QuizTestRecords (as a Stream and as a Future).
Future<int> queryQuizTestRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      QuizTestRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<QuizTestRecord>> queryQuizTestRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      QuizTestRecord.collection,
      QuizTestRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<QuizTestRecord>> queryQuizTestRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
